...
slug: bigfooter
summary: 除雪業務の状況を管理し、市民に分かりやすい情報として届けるためのシステム。
...
市役所職員の知人から、市内の除雪状況を市民へ分かりやすく告知するための画像生成ツールが欲しいと打診がありました。
...
職員が除雪状況を管理するだけでなく、その情報を市民が自分の生活圏と照らし合わせて理解できる形へ変換しました。学校や施設などのランドマークを加え、伝わり方まで検証することで、「情報を公開する」ことから「状況を理解して次の行動を判断できる」ことまでを設計対象にしています。

<p class="eyebrow project-prose__eyebrow">LEARNING</p>

## 得られたこと

地図情報や位置情報を扱う実装経験を得ました。

また、アプリケーションを操作する職員と、出力された情報を見る市民が異なるシステムにおいて、双方のUXを両立する視点を得ました。
